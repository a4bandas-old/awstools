...
server :frontends, :user => 'otlive', :addresses => [
  ...
  '46.137.11.163', # frontend01
  '46.137.22.108', # frontend02
  '46.137.19.59', # frontend03
  '46.137.22.8', # frontend04
  '46.137.2.145', # frontend05
  '46.51.160.48', # frontend06
  '46.137.1.129', # frontend07
  '79.125.33.86', # frontend08
  '46.137.22.235', # frontend09
  '79.125.48.69', # frontend10
  # otlive-autogenerated end
]
